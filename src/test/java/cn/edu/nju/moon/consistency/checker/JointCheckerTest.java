...
//	@Test
	...
	{
		IBasicObservationConstructor fcons = new FileBasicObservationConstructor("src/test/resources/testset/readinc/jt_50_420");
...
//	@Test
	...
	{
		IBasicObservationConstructor fcons = new FileBasicObservationConstructor("src/test/resources/testset/joint/jt_50_10_1720");
		BasicObservation bob = fcons.construct();
...
//	@Test
	...
	{
		IBasicObservationConstructor fcons = new FileBasicObservationConstructor("src/test/resources/testset/joint/jt_50_10_1726");
		BasicObservation bob = fcons.construct();
...
//	@Test
	...
	{
		IBasicObservationConstructor fcons = new FileBasicObservationConstructor("src/test/resources/testset/joint/jt_4_40");
		BasicObservation bob = fcons.construct();
...
//	@Test
	...
	{
		IBasicObservationConstructor fcons = new FileBasicObservationConstructor("src/test/resources/testset/joint/jt_4_40_1");
		BasicObservation bob = fcons.construct();
...
//	@Test
	...
	{
		IBasicObservationConstructor fcons = new FileBasicObservationConstructor("src/test/resources/testset/joint/jt_4_40_2");
		BasicObservation bob = fcons.construct();
