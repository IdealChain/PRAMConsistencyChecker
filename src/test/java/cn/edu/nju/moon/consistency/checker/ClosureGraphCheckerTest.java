...
//	@Test
	public void testCheck_part_fig3()
	{
		...
		IBasicObservationConstructor frobcons_fig3 = new FileBasicObservationConstructor("src/test/resources/testset/operationgraph/obfig3");
...
//	@Test
	public void testCheck_part_fig4()
	{
		...
		IBasicObservationConstructor frobcons_fig4_2b = new FileBasicObservationConstructor("src/test/resources/testset/operationgraph/obfig4case2b");
...
//	@Test
	public void testCheck_part_fig5()
	{
		...
		IBasicObservationConstructor frobcons_fig4_2b = new FileBasicObservationConstructor("src/test/resources/testset/operationgraph/obfig5case1b");
		Checker og_checker_fig4_2b = new ClosureGraphChecker(frobcons_fig4_2b.construct(), frobcons_fig4_2b.get_ob_id());
		og_checker_fig4_2b.check();
	}
...
//	@Test
	public void testCheck_part_fig6()
	{
		...
		IBasicObservationConstructor frobcons_fig4_2b = new FileBasicObservationConstructor("src/test/resources/testset/operationgraph/obfig6");
		Checker og_checker_fig4_2b = new ClosureGraphChecker(frobcons_fig4_2b.construct(), frobcons_fig4_2b.get_ob_id());
		og_checker_fig4_2b.check();
	}
...
//	@Test
	public void testCheck_part_fig7()
	{
		...
		IBasicObservationConstructor frobcons = new FileBasicObservationConstructor("src/test/resources/testset/operationgraph/obfig7");
...
//	@Test
	public void testCheck_part_random_1549()
	{
		...
		IBasicObservationConstructor randcons = new FileBasicObservationConstructor("src/test/resources/testset/randomclosure/1549");
...
//	@Test
	public void testCheck_part_jt_50_420()
	{
		...
		IBasicObservationConstructor frobcons = new FileBasicObservationConstructor("src/test/resources/testset/operationgraph/jt_50_420");
		Checker og_checker = new ClosureGraphChecker(frobcons.construct(), frobcons.get_ob_id());
		og_checker.check();
	}
...
//	@Test
	public void testCheck_part_4_40()
	{
		...
		IBasicObservationConstructor frobcons = new FileBasicObservationConstructor("src/test/resources/testset/randomclosure/4_40");
		Checker og_checker = new ClosureGraphChecker(frobcons.construct(), frobcons.get_ob_id());
		og_checker.check();
	}
}
