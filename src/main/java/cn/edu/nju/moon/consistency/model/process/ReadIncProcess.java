...
//		}
	...
	{
		assert riop.isReadOp() : "READ operation is to check";
	...
	{
		assert cur_wriop.isWriteOp() : "for ReadIncProcess with no masterPid, cur_wriop must be WRITE";
		assert cur_wriop.getPid() == this.pid : "new WRITE cur_wriop must be in this ReadIncProcess";
		assert this.pre_wriop.getIndex() < cur_wriop.getIndex() : "you should advance forward";
	...
	{
		assert cur_rriop.isReadOp() : "for ReadIncProcess with masterPid, cur_rriop must be READ";
		assert cur_rriop.getPid() == this.pid : "new WRITE cur_rriop must be in this ReadIncProcess";
		assert this.pre_rriop.getIndex() < cur_rriop.getIndex() : "you should advance forward in the ReadIncProcess with masterPid";
