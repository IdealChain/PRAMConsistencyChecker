...
//	}
	...
	{
		assert this.isWriteOp() : "Only WRITE operation has wid";
...
//	}
	...
	{
		assert this.isWriteOp() && wriop.isWriteOp() : "W'WR order: WRITE pointing to WRITE";
		assert ! wriop.getWritetoOrder().isEmpty() : "pointing to the WRITE ReadIncOperation which has corresponding READs";
		assert this.getVariable().equals(wriop.getVariable()) : "W'WR order: on two operations performing on the same variable";
