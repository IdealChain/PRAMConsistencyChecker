...
public class GlobalActiveWritesMap
{
	...
	{
		assert wriop.isWriteOp() : "can only be replaced by WRITE ReadIncOperation";
	...
	{
		assert wriop.isWriteOp() : "deactivate WRITEs from WRITE ReadIncOperation";
	...
	{
		assert wriop.isWriteOp() : "active write is of course WRITE";
